...
extension Notification {
  var keyboardHeight: CGFloat? {
    ...
    let screenHeight = UIApplication.shared.windows
      .first(where: { $0.isKeyWindow })?.bounds.height ?? UIScreen.main.bounds.height
